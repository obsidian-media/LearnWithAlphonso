...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: "perfect_1",
    title: "Flawless",
    description: "Finish 1 lesson with no mistakes",
    icon: "star",
    tier: "bronze",
    category: "perfect",
    threshold: 1,
  },
  {
    id: "perfect_10",
    title: "Sharp mind",
    description: "Finish 10 perfect lessons",
    icon: "star",
    tier: "silver",
    category: "perfect",
    threshold: 10,
  },
  {
    ...
    description: "Finish 50 perfect lessons",
    icon: "star",
    tier: "gold",
    category: "perfect",
    threshold: 50,
  ...
  },
  {
    id: "league_promote_1",
    title: "Rising star",
    description: "Advance to a new league",
    icon: "shield",
    tier: "silver",
    category: "league",
    threshold: 1,
  },
  {
    id: "league_promote_3",
    title: "Ascendant",
    description: "Advance to a league 3 times",
    icon: "shield",
    tier: "gold",
    category: "league",
    threshold: 3,
  ...
  },
  {
    id: "freeze_earn_5",
    title: "Cold storage",
    description: "Bank 5 streak freezes",
    icon: "snow",
    tier: "silver",
    category: "freeze",
    threshold: 5,
