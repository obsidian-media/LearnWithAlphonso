...
| u4-u9 | *(Same pattern: 8 key words per lesson)* | `public/audio/{level}/{unit}/{lesson}/{word}.mp3` |
...
| u12 | Review & Consolidation | *(mixed from above)* | `public/audio/a2/review/{word}.mp3` |
...
| u12 | Review & Consolidation | *(mixed)* | `public/audio/b1/review/{word}.mp3` |
...
| u12 | Review & Consolidation | *(mixed)* | `public/audio/b2/review/{word}.mp3` |
...
| u12 | Review & Consolidation | *(mixed)* | `public/audio/c1/review/{word}.mp3` |
